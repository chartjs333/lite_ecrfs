...
@Controller
@RequestMapping("/PINK1PRKN125")
public class PINK1PRKN125Controller {

    @Autowired
PINK1PRKN1Repository25 pink1prkn1repository;
...
PINK1PRKN125  data_to_fill_in =pink1prkn1repository.findBySurveyTwoId(surveyTwoId);
           if (data_to_fill_in==null) {
              data_to_fill_in = new PINK1PRKN125();
    ...
    public String PINK1PRKN1(@PathVariable("surveyTwoId") String surveyTwoId, @ModelAttribute("formObj")PINK1PRKN125 formObj, ModelMap map) {
        if (!StringUtils.isEmpty(surveyTwoId) && ExcelToSurvey.checkKey(surveyTwoId)) {
            PINK1PRKN125 data_to_fill_in =pink1prkn1repository.findBySurveyTwoId(surveyTwoId);
