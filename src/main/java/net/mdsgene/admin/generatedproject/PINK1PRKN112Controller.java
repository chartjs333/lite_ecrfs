...
@Controller
@RequestMapping("/PINK1PRKN112")
public class PINK1PRKN112Controller {

    @Autowired
PINK1PRKN1Repository12 pink1prkn1repository;
...
PINK1PRKN112  data_to_fill_in =pink1prkn1repository.findBySurveyTwoId(surveyTwoId);
           if (data_to_fill_in==null) {
              data_to_fill_in = new PINK1PRKN112();
    ...
    public String PINK1PRKN1(@PathVariable("surveyTwoId") String surveyTwoId, @ModelAttribute("formObj")PINK1PRKN112 formObj, ModelMap map) {
        if (!StringUtils.isEmpty(surveyTwoId) && ExcelToSurvey.checkKey(surveyTwoId)) {
            PINK1PRKN112 data_to_fill_in =pink1prkn1repository.findBySurveyTwoId(surveyTwoId);
