...
@Controller
@RequestMapping("/PINK1PRKN11")
public class PINK1PRKN11Controller {

    @Autowired
PINK1PRKN1Repository1 pink1prkn1repository;
...
PINK1PRKN11  data_to_fill_in =pink1prkn1repository.findBySurveyTwoId(surveyTwoId);
           if (data_to_fill_in==null) {
              data_to_fill_in = new PINK1PRKN11();
    ...
    public String PINK1PRKN1(@PathVariable("surveyTwoId") String surveyTwoId, @ModelAttribute("formObj")PINK1PRKN11 formObj, ModelMap map) {
        if (!StringUtils.isEmpty(surveyTwoId) && ExcelToSurvey.checkKey(surveyTwoId)) {
            PINK1PRKN11 data_to_fill_in =pink1prkn1repository.findBySurveyTwoId(surveyTwoId);
