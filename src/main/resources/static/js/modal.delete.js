$(document).ready(function(){
    ...
    $('#viewModal').on('show.bs.modal', function(e) {
        ...
        $(this).find('.modal-footer .btn-ok').off('click').on('click', function () {
            e.preventDefault();
            var token = $(e.relatedTarget).data('view-token');
            if(token == undefined){
                token = $("meta[name='_csrf']").attr("content");
            }
            var method = $(e.relatedTarget).data('method');
            var parameterName = $(e.relatedTarget).data('view-parameter-name')
            if(parameterName == undefined){
                parameterName = "_csrf";
            }
            var form =$('<form>', {
            ...
            // This will hide the modal when you submit the form
