...
function minimum_part_filled_out() {
	...
	progressbars.forEach((progressbar, index) => {
		if (progressbar) {
			...
			//Jule request to hide warning messages 12.10.2024
			//Пожалуйста, удалите Warning
// Было:
//			alerts[index].setAttribute("style", set2.size == set1.size ? "display:none" : "display:none");
// Заменим на:
			alerts[index].setAttribute("style", "display:none");
